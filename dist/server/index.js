...
function getDraftSecret() {
	return "75335114-82cb-4a6e-b293-b305c5188b02";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2715c2dc-d4ba-4fe6-95e3-ede18cd5d525";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2715c2dc-d4ba-4fe6-95e3-ede18cd5d525") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2715c2dc-d4ba-4fe6-95e3-ede18cd5d525",
		rootBoundaryId
	});
}
/**
