...
function getDraftSecret() {
	return "5a7e683f-d1d7-4477-9a8a-eb7ae48d03db";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e003a21c-19b9-47bc-bcae-4fd953d8a685";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e003a21c-19b9-47bc-bcae-4fd953d8a685") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e003a21c-19b9-47bc-bcae-4fd953d8a685",
		rootBoundaryId
	});
}
/**
