...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-De3ZKZw1.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"281d4dd263d0": async () => {
		const m = await import("./assets/BeyondCode-CY363HkT.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"339f946bc456": async () => {
		const m = await import("./assets/Icon-hPvNhWmy.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"376c6644e256": async () => {
		const m = await import("./assets/ProjectGallery-CYGOZ8VA.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-BF5SyGFY.js");
		return {
			get "ErrorBoundary"() {
	...
	"9fb86276be8f": async () => {
		const m = await import("./assets/image-BVjnQnKd.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ca0d4c23886b": async () => {
		const m = await import("./assets/EventGallery-CUaKnj1F.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { require_react as a, __toESM as c, app_ssr_entry_default as default, handleSsr, useRouter as i, getLayoutSegmentContext as n, __commonJSMin as o, usePathname as r, __exportAll as s, require_jsx_runtime as t };
